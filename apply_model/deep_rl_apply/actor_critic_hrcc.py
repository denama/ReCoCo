...
class ActorCritic(nn.Module):
    ...
    def forward(self, inputs):
        ...
        merge = torch.cat([receiving_flatten, delay_flatten, loss_flatten, predication_flatten, overusedis_flatten,
                           oversuecap_flatten], 1)
        ...
        merge_critic = torch.cat(
            [receiving_flatten_critic, delay_flatten_critic, loss_flatten_critic, predication_flatten_critic,
             overusedis_flatten_critic, oversuecap_flatten_critic], 1)
